(function() {
    var cs = document._currentScript || document.currentScript
        ...
        ;
    var bbbProto = Object.create(HTMLElement.prototype, {
        ...
        , createdCallback:
            {
                value: function() {
                    var tmpl =
                        document.importNode(doc.getElementById("bbb-tmpl").content, true);
                    this._div = tmpl.querySelector("div.bbb");
    ...
    window.BigRedButton = document.registerElement(
		"bigbutton", {
	        prototype: bbbProto,
			namespace: "http://mansoft.nl/big-blue-button"
		}
	);
}());
